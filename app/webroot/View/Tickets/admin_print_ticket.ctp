<div id="main" class="ticket-print">
    ...
    <table class="odds">
        ...
        <tr>
            <td></td>
            <td class="align-right"><?php echo __('Jackpot:'); ?> <?php echo $ticket['Ticket']['amount']*(Configure::read('Settings.jackpotPercent')); ?> <?php echo $currency; ?></td>
        </tr>
        <tr>
            <td></td>
            <td class="align-right">
                ...
                if ($ticket['Ticket']['type'] != 3) {
                    ...
                    //echo Configure::read('Settings.jackpotSize');
                    echo __('JACKPOT');
                }
                ?>
            </td>
