...
<?php echo $this->Html->css(array('reset', 'style','lotterycss')); ?>

<?php echo $this->Html->script(array('tools','jquery-1.6.1.min', 'jquery.cycle.all.min', 'admin/jquery.jclock','jsAction','jquery.slides.min')); ?>
