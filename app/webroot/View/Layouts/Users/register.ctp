    ...
    echo $this->Form->year('date_of_birth', 1920, date('Y')); ?></div>
             ...
             <div class="regFormBox regFormBoxRight">
                 ...
                 <div class="regFormBoxCont">
                     ...
                     <div class="regFormLine">
                         <div class="regFormLineTitle"><?php echo __('Referal ID If Any', true) ?></div>
                         <div class="regFormLineHelp"></div>
              ...
              <div class="regFormBox regFormBoxRight">
                 <div class="regFormBoxTitle"><?php echo __('Bank Data (This section can be filled later under user profile)'); ?></div>
                 <div class="regFormBoxCont">
                     <div class="regFormLine">
                      ...
                      <div class="regFormLine">
                         <div class="regFormLineTitle"><?php echo __('Bank sortcode', true) ?></div>
                         <div class="regFormLineHelp"></div>
                         <div class="regFormLineInput"><?php echo $this->Form->input('bank_code'); ?></div>
                         <div class="regFormLineStatus"></div>
                         <div class="regFormLineInput">Please click <a style="color:orange;" href= "http://www.1960sportsbook.com/others/sortcode.htm" target ="_blank" >Here</a> to find your Bank Sortcode </div>
                </div> 
                     <div class="regFormLine">
...
--> 
    ...
    <div class="regFormBottomBox">
        ...
        <?php echo __('I am over 18 years of age and have read and accepted <a style="color:orange;" href= "/pages/True_and_fair_statement" target ="_blank" >the general terms and conditions </a>, and policies relating to age verification and <a style="color:orange;" href= "/pages/KYC" target ="_blank" >KYC (Know Your Customer).</a>', true); ?>
