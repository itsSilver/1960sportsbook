...
class PaypalComponent extends Component {
	...
	// Live v Sandbox mode !important
        // set to false in production mode, fill
        // $config array with ur correspoding data from paypal
	...
	// test: pwd 329349199
	// test: acc buyer_1325978259_per@gmail.com 
	// test: mantas_1329350984_per@gmail.com
	// pwd: 123456789
	...
	public $sandboxConfig = array(
		...
		'password' => '1325984877',
		'email' => 'mantas_1325984853_biz_api1.gmail.com',
		'signature' => 'An5ns1Kso7MWUdW4ErQKJJJ4qi4-A8cBZiJwFkvGNYYYqq0cSNvSJnY9'
	);

	// API version
	public $apiVersion = '78.0';
	...
	public function setExpressCheckout() {
		...
		//var_dump($setExpressCheckoutNvp);
		//die();
		// Post the NVPs to the relevent endpoint
		//echo $this->config['endpoint'] . " ==== " .$setExpressCheckoutNvp;
