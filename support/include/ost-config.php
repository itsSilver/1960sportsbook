...
define('SECRET_SALT','1N4dkM9knnWwaRuEZklIrZiO4kQTs4aS');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','eamah12@gmail.com');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost');
define('DBNAME','sports_support');
define('DBUSER','sports_main');
define('DBPASS','Vx4VS!A3L#yQ');
